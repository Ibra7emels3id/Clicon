import { DeleteCategory } from '@/lib/features/Category/DeleteCategory';
...
const Dialog = ({ productName, productId, isOpen, setIsOpen }) => {
    const dispatch = useAppDispatch();

    // Handle Delete Product
    const handleConfirm = useCallback(async () => {
        try {
            const res = await dispatch(DeleteCategory(productId));
