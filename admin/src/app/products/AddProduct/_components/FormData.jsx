            ...
            <form className=" space-y-5 w-full">
                <div className='w-full'>
                    ...
                    <div className="flex items-center justify-around flex-wrap ">
                        {formData.image_1 && <Image loading='lazy' className="max-w-28 cursor-pointer" src={URL.createObjectURL(formData.image_1)} alt="uploadArea" width={100} height={100} />}
                        {formData.image_2 && <Image loading='lazy' className="max-w-28 cursor-pointer" src={URL.createObjectURL(formData.image_2)} alt="uploadArea" width={100} height={100} />}
                        {formData.image_3 && <Image loading='lazy' className="max-w-28 cursor-pointer" src={URL.createObjectURL(formData.image_3)} alt="uploadArea" width={100} height={100} />}
                        {formData.image_4 && <Image loading='lazy' className="max-w-28 cursor-pointer" src={URL.createObjectURL(formData.image_4)} alt="uploadArea" width={100} height={100} />}
                        {formData.image_5 && <Image loading='lazy' className="max-w-28 cursor-pointer" src={URL.createObjectURL(formData.image_5)} alt="uploadArea" width={100} height={100} />}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div onChange={(e) => setFormData({
                        ...
                        <select onChange={(e) => setIndex(e.target.selectedIndex - 1)} id="category" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="flex-1 flex flex-col gap-1">
                        ...
                        <input onChange={(e) => setFormData({ ...formData, price: e.target.value })} id="product-price" type="number" placeholder="0" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40" required />
                    </div>
                    <div className="flex-1 flex flex-col gap-1">
                        <label className="text-base font-medium" htmlFor="del-price">Offer Price</label>
                        <input onChange={(e) => setFormData({ ...formData, del_price: e.target.value })} id="del-price" type="number" placeholder="0" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40" required />
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="w-full flex flex-col gap-1">
                        <label className="text-base font-medium" htmlFor="discount">Discount</label>
                        <input onChange={(e) => setFormData({ ...formData, discount: e.target.value })} id="discount" type="number" placeholder="Type here" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40" required />
                    </div>
                    <div className="w-full flex flex-col gap-1">
                        <label className="text-base font-medium" htmlFor="Count">Count</label>
                        <input onChange={(e) => setFormData({ ...formData, count: e.target.value })} id="Count" type="number" placeholder="Type here" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40" required />
                    </div>
                </div>
                <div className="grid grid-cols-1 gap-5">
                    <div className="w-full flex flex-col gap-1">
                        <label className="text-base font-medium" htmlFor="price">Size</label>
                        <select onChange={(e) => setFormData({ ...formData, size: [e.target.value] })} className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40" name="size" id="size">
