...
const Product = ({ category, sort, min, max, search }) => {
            ...
            <div key={it._id} className="box border border-gray-200 relative p-2 group">
                ...
                <div className="text flex flex-col gap-2 p-2">
                    ...
                    <div className="content">
                        <h3 className='text-[15px] font-bold text-gray-500 h-[25px]'>{it.title.slice(0, 20)}...</h3>
                    </div>
                    <div className="price flex items-center gap-2 text-sm">
                        <span className='text-sky-500 font-bold'>${it.price}</span>
                        <span className='text-gray-500 font-bold'><del>${it.del_price}</del></span>
                    </div>
                </div>
            </div >
        ))
