...
import StripePaymentPage from './_components/CheckoutForm';

const Page = () => {
    
    return (
        <div className="bg-white p-4">
            <div className="md:max-w-7xl max-w-xl py-5 lg:px-7 mx-auto">
                            ...
                            <div className="grid gap-4">
                                ...
                                <div className="flex bg-white border border-gray-200 focus-within:bg-transparent overflow-hidden">
                                    ...
                                    <input
                                        ...
                                        className="px-4 py-3.5 bg-white text-gray-700 w-full text-sm focus:bg-transparent outline-none"
                                    />
                                </div>
