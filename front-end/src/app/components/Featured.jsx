            ...
            <div className="flex flex-col">
                <div className="grid grid-cols-7 mt-4 gap-4">
                    <div className="col-span-7 sm:col-span-4 md:col-span-3 lg:col-span-2" >
                        <div className="flex flex-col justify-between bg-[#F3DE6D] border border-[#F3DE6D] space-x-4 h-[683px]">
                            <div className="flex flex-col gap-6  px-4 py-9">
                                <div className="flex items-center justify-center gap-2">
                                    <span className="text-[10px] text-red-600 font-bold">COMPUTER & ACCESSORIES</span>
                                </div>
                                <div className="price flex items-center justify-center gap-2">
                                    <h3 className="text-3xl font-bold text-black">32% Discount</h3>
                                </div>
                                <p className="text-md text-gray-500 text-center font-medium">For all ellectronics products</p>
                                <div className="flex items-center justify-center gap-2">
                                    <p className="text-md text-gray-500">Offers ends in:</p>
                                    <Link href={'/'} className='text-black bg-white px-2 py-1 text-[10px] '>ENDS OF CHRISTMAS</Link>
                                </div>
                                <div className="btn w-full flex items-center justify-center gap-2">
                                    <button className="text-lg font-medium text-white bg-[#FA8232] cursor-pointer px-4 py-3 transition duration-500 ease-in-out transform hover:-translate-y-1 w-[250px]">Shop now</button>
                                </div>
                            </div>
                            <div className="flex w-full items-center">
                                <Image
                                    className="w-full h-[334px] m-auto"
                        ...
                        <div className="flex items-center justify-between  py-2 px-1">
                            ...
                            <div className="list lg:flex hidden">
                                <ul className='flex items-center justify-center gap-3'>
                                    <li onClick={() => {
                                        setCategory('All')
                                    }} className={`text-sm font-medium cursor-pointer hover:underline text-gray-500 hover:text-gray-600 transition duration-500 ease-in-out ${category === 'All' ? 'text-yellow-600 hover:text-yellow-700' : ''}`}>
                                        All Product
                                    </li>
                                    <li onClick={() => {
                                        setCategory('Smart Phone')
                                    }} className={`text-sm font-medium cursor-pointer hover:underline text-gray-500 hover:text-gray-600 transition duration-500 ease-in-out ${category === 'Smart Phone' ? 'text-yellow-600 hover:text-yellow-700' : ''}`}>
                                        Smart Phone
                                    </li>
                                    <li onClick={() => {
                                        setCategory('Computer & Laptop')
                                    }} className={`text-sm font-medium cursor-pointer hover:underline text-gray-500 hover:text-gray-600 transition duration-500 ease-in-out  ${category === 'Computer & Laptop' ? 'text-yellow-600 hover:text-yellow-700' : ''}`}>
                                        Laptop
                                    </li>
                                    <li onClick={() => {
                                        setCategory('Headphone')
                                    }} className={`text-sm font-medium cursor-pointer hover:underline text-gray-500 hover:text-gray-600 transition duration-500 ease-in-out ${category === 'Headphone' ? 'text-yellow-600 hover:text-yellow-700' : ''}`}>
                                        Headphone
                                    </li>
                                    <li onClick={() => {
                                        setCategory('TV & Homes Appliances')
                                    }} className={`text-sm font-medium cursor-pointer hover:underline text-gray-500 hover:text-gray-600 transition duration-500 ease-in-out ${category === 'TV & Homes Appliances' ? 'text-yellow-600 hover:text-yellow-700' : ''}`}>
                                        TV
                                    </li>
                            ...
                            <div className="list hidden max-lg:flex relative group">
                                ...
                                <ul className={`${show ? 'flex opacity-[10]' : 'hidden'} opacity-0 transform transition-all duration-500 ease-in-out  border border-gray-200 z-50 bg-white absolute top-7 p-2 right-0 rounded-xl w-[200px]  flex-col items-center justify-center gap-3`}>
                                    <li onClick={() => setCategory('All')} className="text-sm font-medium cursor-pointer hover:underline text-gray-500 hover:text-gray-600 transition duration-500 ease-in-out">
                                        All Product
                                    </li>
                                    <li onClick={() => setCategory('Smart Phone')} className="text-sm font-medium cursor-pointer hover:underline text-gray-500 hover:text-gray-600 transition duration-500 ease-in-out">
                                        Smart Phone
                                    </li>
                                    <li onClick={() => setCategory('Laptop')} className="text-sm font-medium cursor-pointer hover:underline text-gray-500 hover:text-gray-600 transition duration-500 ease-in-out">
                                        Laptop
                                    </li>
                                    <li onClick={() => setCategory('Headphone')} className="text-sm font-medium cursor-pointer hover:underline text-gray-500 hover:text-gray-600 transition duration-500 ease-in-out">
                                        Headphone
                                    </li>
                                    <li onClick={() => setCategory('TV & Homes Appliances')} className="text-sm font-medium cursor-pointer hover:underline text-gray-500 hover:text-gray-600 transition duration-500 ease-in-out">
                                        TV
                                    </li>
                                    <li onClick={() => setCategory('')} className="text-sm font-medium text-yellow-600 hover:text-yellow-700 transition duration-500 ease-in-out">
                                        <Link href='/' className=''>Browse All Product</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
