                ...
                <div className='container flex items-center justify-center  mx-auto'>
                    <div className="flex flex-col bg-white shadow-2xl w-[450px] m-auto p-5">
                        <div className="title text-center py-4 flex items-center">
                            <Link href={'/User-Account/sign-in'}  className='w-full border-b-2 text-sky-600 font-bold py-2 border-sky-600'>Sign In</Link>
                            <Link href={'/User-Account/sign-up'} className='w-full font-bold'>Sign Up</Link>
                        </div>
                        <FormData/>
                    </div>
                </div>
