...
const FormData = () => {
    ...
    // Handle Send Data
    const HandleSendDataServer = async (e) => {
        e.preventDefault();
    ...
    return (
        <>
            <form action="" method="post" className='flex flex-col gap-3'>
                <div className="name">
                    <label className='block text-gray-600 font-normal' htmlFor="name">Full Name</label>
                    <input onChange={handleChange} className='border border-gray-200 focus:outline-none p-2 w-full mt-1' type="text" id="name" name="name" required placeholder='Enter Full Name' />
                </div>
                <div className="email">
                    <label className='block text-gray-600 font-normal ' htmlFor="email">Email Address</label>
                ...
                <div className="confirm">
                    <label className='block text-gray-600 font-normal' htmlFor="confirmPassword">Confirm Password</label>
                    <input onChange={(e) => {
                        setConfirmPass(e.target.value);
                    }} className='border border-gray-200 focus:outline-none p-2 w-full mt-1' type="password" id="confirmPassword" name="confirmPassword" required placeholder='Confirm Password ...' />
                </div>
                <div className="btn mt-3">
                    {
                        loading ? <button disabled className='bg-[#FA8232] w-full py-2 text-white'>Loading...</button>
                            : <button onClick={HandleSendDataServer} type='submit' className='bg-[#FA8232] w-full py-2 text-white cursor-pointer'>Sign Up</button>
                    }
                </div>
            </form>
            ...
            <div className="btn-SignIn mt-5 flex flex-col gap-3">
                <button onClick={() => {
                    console.log("clicked");
                }} className='flex gap-2 items-center cursor-pointer w-full border border-gray-200 p-2' type='button' >
                    <svg
                        viewBox="-0.5 0 48 48"
                        className='w-8'
                        version="1.1"
